...
### [4. Графемные кластеры: что видит пользователь](04-grapheme-clusters/article.md)
...
### [5. Нормализация Unicode: NFD, NFC, NFKD, NFKC](05-normalization/article.md)
...
### [6. Коллация: Unicode Collation Algorithm и CLDR](06-collation/article.md)
...
### [7. Unicode на практике: Linux, инструменты, исходники ICU](07-linux-tools/article.md)
